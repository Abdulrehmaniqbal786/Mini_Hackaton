...
import { login_account, read_user_data } from '../Config/Firebase/firebase_methods';
...
const Login = () => {
  ...
  return (
    <div className='flex justify-center items-center '>
      ...
      <div className="border-4 rounded w-6/12 max-w-md relative  border-black flex flex-col p-4 rounded-md text-black bg-white">
    <div className="text-2xl font-bold mb-2 text-[#1e0e4b] text-center">Login</div>
...
<div className="text-sm text-center mt-[1.6rem]">Dont have an account yet? <a className="text-sm text-blue-500" href="/signup">SignUp</a></div>
</div>
